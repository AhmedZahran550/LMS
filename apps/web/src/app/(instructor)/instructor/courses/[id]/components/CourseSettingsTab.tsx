    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update the title, description, and visibility of your course.</CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4 max-w-2xl">
            ...
            <div className="space-y-2">
              ...
              <select 
                ...
                disabled={!isEditingSettings}
              >
                <option value={CourseVisibility.PRIVATE}>Private (Only invited students)</option>
                <option value={CourseVisibility.PUBLIC}>Public (Visible to all learners)</option>
              </select>
            </div>
